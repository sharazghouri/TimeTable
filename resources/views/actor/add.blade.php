...
@section('content')
    ...
    <div class="container">
          ...
          <div class="form-group row">
              <form id="data">
                <div class="col-xs-6">
                    <span for="ex1">Actor Name</span>
                    <input class="form-control required" type="text" name="actor_name">
                </div>
        </form>
                <div class="col-xs-6">
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer ">
                    <form id="del_form">
                        <input id="del_cat" name="actor_id"   type="hidden">
                    </form>
                    <button type="button" class="btn btn-success"   onclick="delActor()"><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
...
var url='http://95.215.62.43/onlineM/api/actor/';
    ...
    $.post(url+'get_actors.php',
            ...
            function(data){
                ...
                for(var i =0; i < json.data.length ; i++){
                    ...
                    $('#cat_tbl').append( '<tr>'+
                            '<td>'+json.data[i].actor_id+'</td>'+
                            '<td>'+json.data[i].full_name+'</td>'+
                            ' <td class="text-center"><span data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" onclick="editData('+json.data[i].actor_id+')" ><span class="glyphicon glyphicon-pencil"></span></button></span>'+
                            '<span data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete"  onclick="sureDelete('+json.data[i].actor_id+')" ><span class="glyphicon glyphicon-trash"></span></button></span>'+
                            '</td>'+
                            '</tr>');
